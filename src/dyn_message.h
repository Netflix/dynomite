...
void dnode_req_server_enqueue_imsgq(struct context *ctx, struct conn *conn, struct msg *msg);
void dnode_req_server_dequeue_imsgq(struct context *ctx, struct conn *conn, struct msg *msg);
void dnode_req_client_enqueue_omsgq(struct context *ctx, struct conn *conn, struct msg *msg);
void dnode_req_server_enqueue_omsgq(struct context *ctx, struct conn *conn, struct msg *msg);
void dnode_req_client_dequeue_omsgq(struct context *ctx, struct conn *conn, struct msg *msg);
void dnode_req_server_dequeue_omsgq(struct context *ctx, struct conn *conn, struct msg *msg);
