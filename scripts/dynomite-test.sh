...
#printf '   $2014$ 1 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$4\r\nfoo1\r\n$4\r\nbar1\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-non
...
#printf '   $2014$ 42 3 0 1 *1 d *0\r\n*3\r  $2014$ 43 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo43\r\n$5\r\nbar43\r\n   $2014$ 44 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo44\r\n$5\r\nbar44\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 45 3 0 1 *1 d *0\r\n*3\r\n  $2014$ 46 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo46\r\n$5\r\nbar46\r\n   $2014$ 47 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo47\r\n$5\r\nbar47\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 48 3 0 1 *1 d *0\r\n*3\r\n$  $2014$ 49 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo49\r\n$5\r\nbar49\r\n   $2014$ 50 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo50\r\n$5\r\nbar50\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 51 3 0 1 *1 d *0\r\n*3\r\n$3\r  $2014$ 52 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo52\r\n$5\r\nbar52\r\n   $2014$ 53 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo53\r\n$5\r\nbar53\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

###########

#printf '   $2014$ 54 3 0 1 *1 d *0\r\n*3\r\n$3\r\n  $2014$ 55 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo55\r\n$5\r\nbar55\r\n   $2014$ 56 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo56\r\n$5\r\nbar56\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 57 3 0 1 *1 d *0\r\n*3\r\n$3\r\nse  $2014$ 58 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo58\r\n$5\r\nbar58\r\n   $2014$ 59 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo59\r\n$5\r\nbar59\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 60 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r  $2014$ 61 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo61\r\n$5\r\nbar61\r\n   $2014$ 62 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo62\r\n$5\r\nbar62\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 63 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n  $2014$ 64 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo64\r\n$5\r\nbar64\r\n   $2014$ 65 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo65\r\n$5\r\nbar65\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 66 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$  $2014$ 67 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo67\r\n$5\r\nbar67\r\n   $2014$ 68 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo68\r\n$5\r\nbar68\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 69 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5  $2014$ 70 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo70\r\n$5\r\nbar70\r\n   $2014$ 71 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo71\r\n$5\r\nbar71\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 72 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r  $2014$ 73 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo73\r\n$5\r\nbar73\r\n   $2014$ 74 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo74\r\n$5\r\nbar74\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

printf '   $2014$ 75 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\n  $2014$ 76 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo76\r\n$5\r\nbar76\r\n   $2014$ 77 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo77\r\n$5\r\nbar77\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 78 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\n\foo  $2014$ 79 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo79\r\n$5\r\nbar79\r\n   $2014$ 80 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo80\r\n$5\r\nbar80\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none

#printf '   $2014$ 81 3 0 1 *1 d *0\r\n$3\r\n*3\r\nset\r\n$5\r\nfoo81\r  $2014$ 82 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo82\r\n$5\r\nbar82\r\n   $2014$ 83 3 0 1 *1 d *0\r\n*3\r\n$3\r\nset\r\n$5\r\nfoo83\r\n$5\r\nbar83\r\n' | socat ${debug} ${timeout} - TCP:localhost:${port},shut-none
